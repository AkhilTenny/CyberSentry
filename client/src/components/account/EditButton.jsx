...
function EditButton(props) {
  ...
  return (
    ...
    className=' ml-4 flex w-20 rounded-md border-2 justify-around cursor-pointer hover:bg-gray-200 items-center '>
      <h1 className='text-lg  font-bold text-gray-600'>Edit</h1>
